            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  width:
                      size == Sizes.Large ? Get.width * 0.6 : Get.width * 0.8,
                  height:
                      size == Sizes.Large ? Get.height * 0.5 : Get.height * 0.6,
                  child: Center(
                    child: Row(
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                      ...
                      child: Icon(
                        Icons.close_rounded,
                        size: WindowSizes.size(Get.width) == Sizes.Large
                            ? 50
                            : 30,
                      )),
                )
